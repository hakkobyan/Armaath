...
const styles = StyleSheet.create({
  ...
  lesson: { flex: 1, fontSize: 16, fontWeight: "800" },
  ...
  meta: { fontSize: 13, fontWeight: "700", color: "#30384B" },
  metaDesktop: { fontSize: 16 },
  cancelled: { textDecorationLine: "line-through", color: "#a33" },
  muted: { color: "#686879", fontSize: 13, lineHeight: 18 },
  description: { fontSize: 14, lineHeight: 20, color: "#30384B" },
  actions: { flexDirection: "row", gap: 18, marginTop: 8, paddingTop: 2 },
  link: { color: "#5142da", fontSize: 13, fontWeight: "800" },
  danger: { color: "#b42336", fontSize: 13, fontWeight: "800" },
