...
const styles = StyleSheet.create({
  ...
  logoDesktop: { color: colors.primaryBorder },
  title: { fontSize: 30, fontWeight: "900", color: colors.ink },
  titleDesktop: { color: colors.white, fontSize: 46, marginTop: 10 },
  subtitle: { color: colors.muted, fontSize: 14 },
  subtitleDesktop: { color: colors.primarySoft, fontSize: 18 },
  desktopNote: {
    marginTop: 64,
    padding: 20,
    borderRadius: 20,
  ...
  desktopNoteTitle: { color: colors.white, fontSize: 18, fontWeight: "800" },
  desktopNoteText: { color: colors.primarySoft, fontSize: 15, lineHeight: 22 },
  form: {
    gap: 12,
